...
,m_aaParam{
	{	IDC_TIMBRE_EN_STATIC,
		...
		IDC_TIMBRE_EPR_STATIC,
		IDC_TIMBRE_KT_STATIC,
		IDC_TIMBRE_DT_STATIC,
	},
	{	IDC_TIMBRE_EN1_STATIC,
		IDC_TIMBRE_AL1_STATIC,
		IDC_TIMBRE_DL1_STATIC,
		IDC_TIMBRE_SL1_STATIC,
		IDC_TIMBRE_RL1_STATIC,
	...
	{	IDC_TIMBRE_EN2_STATIC,
		IDC_TIMBRE_AL2_STATIC,
		IDC_TIMBRE_DL2_STATIC,
		IDC_TIMBRE_SL2_STATIC,
		IDC_TIMBRE_RL2_STATIC,
	...
	{	IDC_TIMBRE_EN3_STATIC,
		IDC_TIMBRE_AL3_STATIC,
		IDC_TIMBRE_DL3_STATIC,
		IDC_TIMBRE_SL3_STATIC,
		IDC_TIMBRE_RL3_STATIC,
...
void CModuleTab::OnBnClickedModuleLoadButton()
{
	...
	CFileDialog FileDialog(true, _T("wtxfm"), _T("*.wtxfm"), OFN_FILEMUSTEXIST | OFN_EXTENSIONDIFFERENT);
...
void CModuleTab::OnBnClickedModuleSaveButton()
{
	...
	CFileDialog FileDialog(false, _T("wtxfm"), _T("*.wtxfm"), OFN_OVERWRITEPROMPT | OFN_EXTENSIONDIFFERENT);
	if (FileDialog.DoModal() == IDOK){
		SetTabName(FileDialog.GetFileTitle());
...
void CModuleTab::DrawAllParam()
{
	...
	{	// 
		auto& rValueNew = GetParamValue(1, 0);
...
void CModuleTab::Rotate()
{
	...
	auto iRotate = (my-1);
	if (iRotate >= 0 && iRotate < _countof(_.aOperator)){
		if (!m_bRotate){
			FixParam();
